...
from trabalho02.outros.operacoes_grafo import inserir_nodo_grafo
...
def busca_gulosa(grafo: MultiDiGraph):
    ...
    while True:
        ...
        for nodo in borda.copy():
            nodo["custo_caminho"] = calcular_heuristica(grafo, nodo) # faço o custo do caminho ser o da heurística
